				...
				<div id="review_form_wrapper">
					<div id="review_form">
						<?php
							...
							$comment_form = array(
								...
								'fields'               => array(
									'author' => '<p class="comment-form-author">'.
												'<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" required placeholder="Họ và Tên *" /></p>',
							...
							$comment_form['comment_field'] .= '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required placeholder="Nội dung đánh giá *"></textarea></p>';
